...
data = dict(
    ...
    train =dict(
        type=dataset_type,
        ann_dir=ann_dir + 'split2_train_MultiStfKFold_pseudo',
        img_dir=img_dir + 'split2_train_MultiStfKFold_pseudo',
        classes = classes,
        palette= palette,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_dir=ann_dir + 'split2_val_MultiStfKFold',
        img_dir=img_dir + 'split2_val_MultiStfKFold',
        classes = classes,
        palette= palette,
